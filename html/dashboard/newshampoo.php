...
if(isset($_POST['upload'])){
    ...
    $sql ="INSERT INTO tb_shampoo(title,image_file,caption,price) VALUES ('$title','$image','$caption','$price')";
...
<html lang="en">
 ...
 <div class="d-flex flex-column p-3 text-white bg-dark" style="width: 280px; height: 800px;">
  ...
  <div class="container-l me-5">
    <h2>New Pet Shampoo</h2>
    <h3>Please fill the form below to edit the data</h3>
    <br>
    <hr class="bg-danger border-2 border-top border-danger">    
    <form action="newdogfood.php" method="POST" enctype="multipart/form-data">
   <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="other" class="form-control" name="price" id="price">
  </div>
