  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo "<a href='editcatsnack.php?idcatfood=$ptrid'>UPDATE</a>| 
								<a href=<test.php?idcatsnack=$ptrid'>DELETE</a>"; ?> </td>
      </tr>
    </tbody>
        <?php
    }
