...
<html lang="en">
 ...
 <div class="d-flex flex-column p-3 text-white bg-dark" style="width: 280px; height: 800px;">
  ...
  <div class="container-l me-5">
    ...
    <form action="phpaction/editcatsnackaction.php" method="POST" enctype="multipart/form-data">
   <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label"> Title</label>
    <input type="other" class="form-control" name="title" id="email" >
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label"> Videos </label>
