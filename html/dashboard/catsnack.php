  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo "<a href='editcatsnack.php?idcatsnack=$ptrid'>UPDATE</a>| 
								<a href=<deletecatsnack.php?delcatsnack=$ptrid'>DELETE</a>"; ?> </td>
      </tr>
    </tbody>
        <?php
    }
