  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo "<a href='editdogsnack.php?iddogsnack=$ptrid'>UPDATE</a>| 
								<a href=<deletedogsnack.php?deldogsnack=$ptrid'>DELETE</a>"; ?> </td>
      </tr>
    </tbody>
        <?php
    }
