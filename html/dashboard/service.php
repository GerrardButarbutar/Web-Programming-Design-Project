...
<html lang="en">
  <head>
    ...
    <title>SERVICE CONTENT MANAGEMENT - Jordan Petshop</title>
  </head>
  <body>
  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo $ptrimage ?></td>
        <td><?php echo "<a href='editservice.php?idhome=$ptrid'>UPDATE</a>| 
