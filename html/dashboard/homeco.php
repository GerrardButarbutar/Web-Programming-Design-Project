...
<html lang="en">
  <head>
    ...
    <title>HOME CONTENT MANAGEMENT - Jordan Petshop</title>
  </head>
  <body>
 ...
 <div class="d-flex flex-column p-3 text-white bg-dark" style="width: 280px; height: 800px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="homeco.php" class="nav-link active text-white" aria-current="page">
  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo $ptrvid ?></td>
        <td><?php echo "<a href='editdogfood.php?idhome=$ptrid'>UPDATE</a>| 
								<a href=<test.php?idhome=$ptrid'>DELETE</a>"; ?> </td>
      </tr>
    </tbody>
        <?php
    }
