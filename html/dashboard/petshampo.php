<?php
    ...
    $query = 'SELECT * FROM tb_petshampoo';
  ...
  <div class="container-l me-5">
    ...
    ?>
      <tr>
        ...
        <td><?php echo "<a href='editdogsnack.php?idpetshampoo=$ptrid'>UPDATE</a>| 
								<a href=<deleteshampoo.php?delpetshampoo=$ptrid'>DELETE</a>"; ?> </td>
      </tr>
    </tbody>
        <?php
    }
